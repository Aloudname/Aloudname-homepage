...
export default {
  ...
  data() {
    return {
      ...
      locked: false,
      btnFlag: false,
      bannerImage: "http://chaichaiimage.oss-cn-hangzhou.aliyuncs.com/blog3.0/bg16.jpg",
      title: "首页",
      sidebarAvatar: "https://chaichaiimage.oss-cn-hangzhou.aliyuncs.com/blogimg/0d1b2cad168244918d2ee927bb664eb5.jpeg",
      sidebarName: "柴柴",
      sidebarBio: "老爷保佑！前途无量！",
